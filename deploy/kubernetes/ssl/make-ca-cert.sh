...
cert_ip=$master_server01

sans="IP:$master_server01,IP:$master_server02,IP:$master_server03,IP:10.254.0.1,DNS:kubernetes,DNS:kubernetes.default,DNS:kubernetes.default.svc,DNS:kubernetes.default.svc.cluster.local"
cert_dir=${CERT_DIR:-/opt/kubernetes/ssl}
