...
KUBE_CONTROLLER_MANAGER_ROOT_CA_FILE="--root-ca-file=/opt/kubernetes/ssl/ca.crt"
...
KUBE_CONTROLLER_MANAGER_SERVICE_ACCOUNT_PRIVATE_KEY_FILE="--service-account-private-key-file=/opt/kubernetes/ssl/server.key"
EOF
...
KUBE_CONTROLLER_MANAGER_OPTS1="  \${KUBE_LOGTOSTDERR} \\
                                \${KUBE_LOG_LEVEL}   \\
                                \${KUBE_MASTER}"
