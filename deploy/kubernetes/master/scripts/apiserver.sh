...
KUBE_API_ADDRESS="--insecure-bind-address=${MASTER_INSECURE_ADDRESS}"

# --insecure-port=8080: The port on which to serve unsecured, unauthenticated access.
KUBE_API_PORT="--insecure-port=8080"

KUBE_API_SECURE_PORT="--secure-port=443"
...
KUBE_API_CLIENT_CA_FILE="--client-ca-file=/opt/kubernetes/ssl/ca.crt"
...
KUBE_API_TLS_CERT_FILE="--tls-cert-file=/opt/kubernetes/ssl/server.cert"

# --tls-private-key-file="": File containing x509 private key matching --tls-cert-file.
#KUBE_API_TLS_PRIVATE_KEY_FILE="--tls-private-key-file=/srv/kubernetes/server.key"
KUBE_API_TLS_PRIVATE_KEY_FILE="--tls-private-key-file=/opt/kubernetes/ssl/server.key"
...
KUBE_APISERVER_OPTS1="   \${KUBE_LOGTOSTDERR}         \\
                        \${KUBE_LOG_LEVEL}           \\
                        \${KUBE_ETCD_SERVERS}        \\
                        \${KUBE_API_ADDRESS}         \\
                        \${KUBE_API_PORT}            \\
