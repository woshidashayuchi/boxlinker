...
class LogManager(object):
    ...
    #@acl_check
    def pod_log_list(self, token, user_name, user_role,
                     user_orag, user_ip, resource_name,
                     resource_type, label_value=None,
        ...
        for pod_log in pod_logs_list:
            ...
            log.debug('epoch_time=%s, type=%s' % (epoch_time, type(epoch_time)))
            ...
            log.debug('user_name=%s, user_role=%d' % (user_name, int(user_role)))
            ...
            try:
                ...
                try:
                    ...
                    if (label_tag == 'boxlinker') and (int(user_role) != 0):
                        continue
                except Exception, e:
                    pass
