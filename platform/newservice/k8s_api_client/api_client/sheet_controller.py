...
class SheetController(object):
    ...
    def detail_service(json_list):
        ...
        try:
            ...
            log.warning('k8sapi get the detail resource(out) running error, reason=%s' % e)
            return code.request_result(404)
        return code.request_result(0, result_one)
    ...
    def update_service(json_list):
            ...
            if json_list.get("rtype") == "domain_change":
                ...
                try:
                    ...
                    log.error('k8sapi struct the update_sql running error, reason=%s' % e)
