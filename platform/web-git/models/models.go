...
import (
	...
	"github.com/cabernety/boxlinker-git/models/migrations"
...
func LoadConfigs() {
	...
	DbCfg.Host = os.Getenv("MYSQLHOST")
	DbCfg.Name = os.Getenv("MYSQLNAME")
	DbCfg.User = os.Getenv("MYSQLUSER")
	DbCfg.Passwd = os.Getenv("PASSWD")

	if DbCfg.Host == "" && DbCfg.Name == "" && DbCfg.User == "" && DbCfg.Passwd == "" {
