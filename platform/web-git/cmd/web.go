...
import (
	...
	"github.com/cabernety/boxlinker-git/modules/bindata"
	"github.com/cabernety/boxlinker-git/modules/context"
	"github.com/cabernety/boxlinker-git/modules/form"
	"github.com/cabernety/boxlinker-git/modules/mailer"
	...
	"github.com/cabernety/boxlinker-git/routers/admin"
	apiv1 "github.com/cabernety/boxlinker-git/routers/api/v1"
	"github.com/cabernety/boxlinker-git/routers/dev"
	"github.com/cabernety/boxlinker-git/routers/org"
	"github.com/cabernety/boxlinker-git/routers/repo"
...
func runWeb(ctx *cli.Context) error {
	...
	m.Group("/repo", func() {
		...
		m.Post("/pullaction", user.GetActionWithTime)
	...
	m.Group("/:username/:reponame", func() {
		...
		m.Group("/issues", func() {
			...
			m.Group("/:index", func() {
				...
				m.Post("/delete", repo.DeleteIssue)
	...
	m.Group("/:username/:reponame", func() {
		...
		m.Group("/issues", func() {
			m.Group("/:index", func() {
				...
				m.Post("/importance", repo.UpdateIssueImportance)
			}, reqRepoWriter)
		})
		m.Group("/labels", func() {
	...
	m.Group("/:username", func() {
		m.Get("/:reponame", reqSignIn, context.RepoAssignment(), context.RepoRef(), repo.Home)
