...
class BalancesManager(object):
    ...
    def balance_init(self, user_uuid):

        try:
            self.billing_db.balance_insert(user_uuid)
        except Exception, e:
    ...
    def balance_update(self, user_uuid, amount):
        ...
        try:
            self.billing_db.balance_update(user_uuid, amount)
        except Exception, e:
    ...
    def balance_info(self, user_uuid):
        ...
        try:
            balance_info = self.billing_db.balance_info(user_uuid)
        except Exception, e:
